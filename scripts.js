function clearAll()
{
  const a = document.querySelector(".meme-content");
  const b = document.querySelector(".joke-content");
  const c = document.querySelector(".quote-content");
  const d = document.querySelector(".riddle-content");
...
function showMeme()
{
  ...
  // ! document.createElementNode('IMG');
  
  // ! document.createAttributeNode('src');
  const b1 = document.createAttribute('src');
  b1.value = randomMemeUrl;
  
  const b = document.createElement('img');
  b.setAttributeNode(b1);
...
function showJoke()
{
  ...
  // clap clap for ->  "textContent"
  a.textContent=randomJokeText;
  // ! const b=document.querySelector(.joke-content);
  const b=document.querySelector(".joke-content");
  clearAll();
  b.appendChild(a);
...
function showQuote()
{
  ...
  // ! blockQuote
  const a1 = document.createElement('blockquote');
  a1.textContent=randomQuote.quote;
  const a2 = document.createElement('p');
  a2.textContent=randomQuote.author+":";

  // ! const b=document.querySelector(.joke-content);
  const b=document.querySelector(".quote-content");
  clearAll();
  b.appendChild(a2);
  b.appendChild(a1);
}
...
function showRiddle()
{
  ...
  b1.textContent = randomRiddle.question;
  
  const b2 = document.createElement('h4');
  b2.setAttribute('id','riddle-ans');
  b2.textContent = randomRiddle.answer;
  b2.hidden = true;
  
  const a = document.querySelector(".riddle-content");
  clearAll();
  a.appendChild(b1);
  a.appendChild(b2);
...
function revealAnswers(ans)
{
   if(document.querySelector('.riddle-content').innerHTML==''){
       alert('There is no riddle question');
        return;
     }
    if(!document.querySelector('#riddle-ans').hidden)
     {
       alert('The Answer is already revealed');
       return;
     }
 document.querySelector('#riddle-ans').hidden=false;
}
